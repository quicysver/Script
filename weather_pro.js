...
lat_lon:"34.7712025252,113.862108332", //请填写经纬度,直接从谷歌地图中获取即可
  ...
  show: {
        ...
        template: {
            title: `$[city]$[district]`,
            subtitle: `[天气日报] $[summary] `,
            detail: `$[weatherIcon]$[weather] $[temperatureMin] ~ $[temperatureMax]°C ☔️降雨概率 $[precipProbability]%
😷空气质量 $[aqi]($[aqiDesc]) 🍃风速$[windSpeed]km/h $[windDir]
